...
<div class="breadcrumbwidget">
      ...
      <div class="pagetitle">
        	<h1>Açıklama</h1> <span>Sitenizin galeri kategorilerini ve tüm resimlerini bu bölümden düzenleyebilirsiniz.</span>
    ...
    <i class="iconsweets-denied iconsweets-white"></i>
        ...
        <div class="maincontent">
        	<div class="contentinner">
            	...
            	<h4 class="widgettitle">Galeri Resim Düzenleme Bölümü</h4>
            	<table class="table table-bordered" id="dyntable">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="head0">Galeri ana resmi</th>
							<th class="head1">Galeri kategorisi</th>
                            <th class="head1">Galeri resim adedi</th>
                    ...
                    <tbody>
                        ...
                        <tr class="gradeX">
                           <td class="aligncenter"><span class="center">
							...
							$galerresimler	=mysql_query("select * from galeriresim where galustid='$vid'");
							$resimsay=mysql_num_rows($galerresimler);
							echo "Galeriye ait toplam ".$resimsay." adet resim bulundu";
							
							?>
							</center></td>

                  
							<td><center><a href="ana.php?git=galeriresimduzenle&id=<?php echo $vid;?>" title="DUZENLE"><img class="icon-edit"></a>   <a href="ana.php?git=galeriresimsil&id=<?php echo $hid;?>" title="SİL"><img class="icon-remove" style="margin-left:40px;"></a></center></td>
                        </tr>
						<?php } ?>
