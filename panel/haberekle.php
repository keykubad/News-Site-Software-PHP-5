		...
		if($_POST){
			...
			$hmanset				= $_FILES["hmanset"]["tmp_name"];
					...
					if($hmanset==""){
						...
						yorumakapa) values ('$sonrakitarihsaat','$haberkat','$hbaslik','$hetiket','$hkisa','$hicerik',
						'$videokod','$haktif','$mansetgoster','$anasayfagoster','$ustmanset','$sondakika','$flash',
						'$yorumkapa') ");
							if($haberekle){
								uyari("Haber Başarıyla Eklendi!!");
						...
						$haberekle	=mysql_query("insert into haberler (tarihsaat,haberkategori,hbaslik,hetiket,
						hkisa,hicerik,videokod,aktif,mansetgoster,anasayfagoster,ustmanset,sondakika,flash,
						yorumakapa,hmanset) values ('$sonrakitarihsaat','$haberkat','$hbaslik','$hetiket','$hkisa','$hicerik',
						'$videokod','$haktif','$mansetgoster','$anasayfagoster','$ustmanset','$sondakika','$flash',
						'$yorumkapa','$yuklenenresim') ");
							if($haberekle){
								uyari("Haber Başarıyla Eklendi!!");
								git("ana.php?git=haberekle","1");
							}else{
                ...
                <div class="widgetcontent bordered shadowed nopadding">
                    <form class="stdform stdform2" method="post" action="" enctype="multipart/form-data">
						 ...
						 ?>  	
							 ...
							 ?>" <?php if($date==$gunu){ echo "selected";} ?>>
							 <?php 			
							 if($date<=9){
								echo "0".$date;
						...
						?>
						 ...
						 ?>  	
								...
								?>" 
								<?php if($month==$ayi){ echo "selected";} ?>>
								<?php 
						...
						<select name="saatilk" class="uniformselect" style="width:50px;">
						 ...
						 ?>  
								...
								?>" <?php if($saatilk==$saatilki){ echo "selected";} ?>>
						 <?php 			
						 if($saatilk<=9){
									echo "0".$saatilk;
						...
						?>
						 ...
						 ?>  
								...
								?>" <?php if($saatiki==$saatikisi){ echo "selected";} ?>><?php 
